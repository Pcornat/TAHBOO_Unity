...
namespace HumanScripts
{
	public class HumanScript : MonoBehaviour
	{
		...
		void Awake()
		{
			...
			this._humanInstance = HumanDLLInterface.Human_create("/home/postaron/Codes/Unity/TAHBOO/Assets/Scripts/HumanScripts/config.json");
			...
			IntPtr start = IntPtr.Add(tabIds, sizeof(long));
